...
class Transaction(Gclass):
    ...
    att = ['_id', '_seller_id', '_marketplace_id', '_date', '_transactions']

    # Class header title
    header = 'Transactions'

    # field description for use in, for example, input form
    des = ['Id', 'Seller_id','Marketplace_id', 'Date', 'Transactions']

    # Constructor: Called when an object is instantiated
    def __init__(self, id, seller_id, marketplace_id, date, transactions):
        super().__init__()
